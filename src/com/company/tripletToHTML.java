...
public class tripletToHTML {
    ...
    public static void tripletToHTML(int f, int s, int t) {
        ...
        int st = t%16;
        int x = 0;
        for (String pi: HTMLHex) {
            if (("#" + hexa[ff] + hexa[sf] + hexa[fs] + hexa[ss] + hexa[ft] + hexa[st]).toUpperCase().equals(pi)){
